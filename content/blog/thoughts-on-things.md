...
Even if a user does settle on one app, a subscription model demands that the app's use continues. Unless that app pays for itself every month, it just becomes a cost and could be deemed expendible. The really low price point makes this more acceptable to a user, but requires the developer to sign up users in huge volumes to make any meaningful money.
...
This approach inspires confidence because I know that if I do stump up and pay the £xx for the full suite of apps, I probably won't be asked to pay more in a few months time - something I've been burnt by as a company suffles around it's subscription tiers. Equally, paying a fair price (and let's be honest, the asking price is more than fair for the work that would have been put into this) gives me confidence that Cultured Code are making money. Them making money is a good thing, because it hopefully means they'll still be here in another decade, releasing beautifully crafted software that is a joy to use.
...
An example of this is [Basecamp](https://basecamp.com). Their model is a flat rate, monthly subscription of $99. There are no tiers or per-user fees which is so refreshing. So often this sort of business model is riddled with upsells, or necessary features reserved for high-price plans.
...
## How we can
Pricing software has always been difficult. I'm not sure that either the subscription or up-front business model is the correct one. Both have their place.

What I am sure of is that far too few companies are releasing truly great software. The guys at Basecamp and Cultured Code show that two different routes are possible, but as proved by [Panic's issues with building for iOS](https://panic.com/blog/the-2016-panic-report/) (see "Challenges"). A few years back, they bet big on building a pro-level iOS equivalent to [Coda](https://panic.com/coda/), but unfortunately found only a very small market - which is a shame, because I loved their app and love working on my iPad Pro. I wish there was more software of that quality for it.
...
What Apple **does** need is an iOS ecosystem that is a legitimate operating system for proper work. Ardent iPad-user Federico Vitici said as much in his recent demo of what he hopes [iOS 11 could deliver](https://www.macstories.net/stories/ios-11-ipad-wishes-and-concept-video/).
...
At this risk of being overly-dramatic, I'd say the future of iOS relies heavily on incentivising developers and educating users about the true value of great software.
